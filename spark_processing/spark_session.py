...
_hadoop_home = os.getenv("HADOOP_HOME", "").strip()
if _hadoop_home and os.name == "nt":
...
def get_spark_session(app_name: str = None, *, with_kafka: bool = False) -> SparkSession:
    ...
    if with_kafka:
        builder = builder.config(
            "spark.jars.packages",
            os.getenv("SPARK_KAFKA_PACKAGE", "org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.1"),
        )
